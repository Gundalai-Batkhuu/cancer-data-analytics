...
# cancer_data_analytics documentation build
...
from cancer_data_analytics import __version__ as release

# -- Project information -----------------------------------------------------

project = "cancer_data_analytics"
author = "Kedro"
...
htmlhelp_basename = "cancer_data_analyticsdoc"
...
latex_documents = [
    (
        master_doc,
        "cancer_data_analytics.tex",
        "cancer_data_analytics Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cancer_data_analytics",
        "Project cancer_data_analytics codebase.",
        "Data-Science",
    )
]
